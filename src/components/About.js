        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-4">
            <Image
              ...
              width={1000}
              height={1000}
              className="object-contain h-600 object-center group-hover:opacity-75"
            />
          </div>
          <div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              <p className="mb-4 text-md leading-8 text-[#A4A4A4] text-center sm:text-left">
                About Us
              </p>
              <h2
                className={`${playfair_display.className} mb-12 text-3xl font-bold text-[#333333] text-center sm:text-left sm:text-4xl`}
              ...
              <div className="max-w-xl">
                <p className="mt-4 text-[#999999]">
                  You dont have to worry about the results because all of these
            ...
            <dl className="mt-10 grid grid-cols-2 gap-8 sm:grid-cols-5">
              {stats.map((stat, statIdx) => (
                <div key={statIdx}>
                  <dd className="mt-2 text-3xl font-bold leading-10 tracking-tight text-[#006D5B]">
                    {stat.value}
                  </dd>
                  <dt className="text-sm font-semibold leading-6 text-[#999999]">
                    {stat.label}
                  </dt>
                </div>
              ))}
